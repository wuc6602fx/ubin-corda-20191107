#!/usr/bin/env bash
curl -X PUT "http://localhost:10003/api/cash/self-issue-cash?amount=500&currency=SGD"
curl -X PUT "http://localhost:10006/api/cash/self-issue-cash?amount=500&currency=SGD"
curl -X PUT "http://localhost:10009/api/cash/self-issue-cash?amount=500&currency=SGD"
